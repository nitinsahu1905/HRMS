    ...
    <div className="flex flex-col gap-[10px]">
      ...
      <div className="flex flex-row gap-[10px]">
        ...
        <div className="w-2/5 bg-white rounded-lg h-auto flex flex-col">
          <div className="top-2 mt-3 left-1 text-dark-blue font-medium text-2xl px-3">
            Announcement
          </div>
          ...
          <div className="flex justify-between bg-white border-[#0684C7] border-[1px] rounded-lg w-auto h-auto mx-4 p-2 mb-2 mt-2">
            <div className="p-2 w-full ">
              <textarea
                ...
                className="outline-none w-full h-full overflow-hidden resize-none "
                wrap="soft"
                maxLength={300}
                onChange={(e) => setAnnouncement(e.target.value)}
              ></textarea>
            </div>
            <span className="end-0 right-0 pt-40">
              <RiSendPlaneFill
                onClick={() => {
                  document.querySelector("#announcement").value = "";
                  setAnnouncement("");
                }}
                className="transform rotate-45 h-6 w-6 text-primary-blue cursor-pointer"
              />
            </span>
          </div>
        </div>

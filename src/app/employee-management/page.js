    ...
    <div className="flex flex-col gap-3 pr-4">
      ...
      <div className="flex justify-between items-center p-4  bg-white rounded-[10px]">
        ...
        <div className="flex flex-row gap-2">
          <button className="cursor-pointer bg-button-blue-color rounded-[10px] text-white px-[27px] py-[12px] h-full ">
            + Add Employee
          </button>
          <Link href="./import-employees">
            <button className="bg-[#f7f7f7] rounded-[10px] px-[25px] py-[10px] border-2 border-primary-blue text-primary-blue">
              Import Employees
            </button>
          </Link>
        </div>
